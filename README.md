...
| プラグイン | 内容 |
|---|---|
| [work-rules-check](./plugins/work-rules-check) | 就業規則を労働基準法などに照らして点検し、必須記載事項の漏れ・違法やリスクのある条項・法改正への未対応・形式面の不整合をレポートにまとめる |
...
/plugin install work-rules-check@work-regulations-check
```
