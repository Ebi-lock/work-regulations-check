...
すべてを一度に聞くと相手が答えられない。8つの段階に分けてある。

1. **対象となる事業場・従業員** — 事業場の数、事業場ごとの人数、**雇用形態の内訳**
2. **労務制度** — 労働時間、休日・休暇、賃金
3. **人事制度** — 採用・異動、退職・解雇
4. **服務規律・懲戒** — 何を禁止するか、**どの行為がどの処分に当たるか**
5. **安全衛生・福利厚生**
6. **育児・介護・多様な働き方**
7. **他の規程・書面との関係** — 既にあるものを出してもらう
8. **施行と手続**

段階1と2で条文の骨格が決まる。段階3以降は「制度があるかないか」を先にまとめて聞き、
「ある」と答えたものだけ細目に入る。

### 段階1を雑にしない

**雇用形態の内訳を聞かないと、あとで「その層に適用される規則が無い」という穴があく。**
正社員・パート・契約・嘱託・定年後再雇用が何人ずついるかを、事業場ごとに確認する。
「常時10人」の判定にはパート・アルバイトも含まれる。

### 段階4は業種で重みが変わる

服務規律は規程の性格が最も出る部分。顧客情報を扱うならセキュリティと個人情報を厚く、
接客業ならカスハラと SNS を厚くする。一律に並べず、**何が実際の問題なのか**を聞く。

懲戒は種類を並べるだけでは足りない。労基法89条9号は制裁の「種類**及び程度**」を求めており、
**どの行為がどの処分に当たるか**を書かないと、実際に処分したときに根拠を示せない。

### 段階7を飛ばさない

新規作成でも、既にある書面との整合は確認する。労働協約、労働条件通知書、
既存の別規程、36協定、各種労使協定。**労働協約に反する就業規則は無効**になる
（労基法92条、労働契約法13条）。就業規則だけ新しくして労働条件通知書が古いままだと、
どちらが適用されるかで争いになる。
